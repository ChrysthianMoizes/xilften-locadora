...
<html lang="pt-br">
    ...
    <body>
        ...
        <div id="main" class="container-fluid">
              ...
              <h3 class="page-header">Cadastrar Diretor</h3>
              <br><hr />     
              <form method="POST" action="/locadora/CtrlCadastrarDiretor">
                    <div class="row">
                      <div class="form-group col-md-4">
                            <label for="exampleInputEmail1">Nome</label>
                            <input type="text" class="form-control" name="nome" id="exampleInputEmail1" placeholder="ex: Sojé Amado">
                      </div> 
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title">Incluir Diretor</h4>
