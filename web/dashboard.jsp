                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item dropright">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">
                                    ...
                                    Classe
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="Modulos/Classe/cadastraClasse.html">Cadastrar</a>
                                        <a class="dropdown-item" href="Modulos/Classe/alteraClasse.html">Alterar</a>
                                        <a class="dropdown-item" href="Modulos/Classe/excluiClasse.html">Excluir</a>
                                    </div>
                                </a>
                            </li>
                            <li class="nav-item dropright">
                        ...
                        <div class="col">
                            <table border="0">
                                <form class="form-inline"> 
                                    <tr>
                                        <td>
                                            <button id="btnEfetuarLocacao" onclick="efetuarLocacao()" type="button" class="btn btn-outline-success">Efetuar Locação</button>
                                        </td>
                                        <td></td>
                                        <td>
                                            <button id="btnAlterarLocacao" onclick="alterarLocacao()" type="button" class="btn btn-outline-secondary">Alterar Dados da Locação</button>
                                        </td>
                                        <td></td>
                                        <td>
                                            <button id="btnCancelarLocacao" onclick="cancelarLocacao()" type="button" class="btn btn-outline-danger">Cancelar Locação</button>
                                        </td>
                                        <td></td>
                                        <td>
                                            <button id="btnEfetuarDevolucao" onclick="efetuarDevolucao()" type="button" class="btn btn-outline-primary">Efetuar Devolução</button>
                                        </td>
                                    </tr>
                                </form>
                            </table>   
